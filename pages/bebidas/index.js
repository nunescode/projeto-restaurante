...
const index = () => {
  ...
  function getAll() {
    axios.get("/api/bebidas").then((resultado) => {
  ...
  const adicionarAoCarrinho = async (item) => {
    try {
      ...
      console.log("Bebida adicionada ao carrinho:", response.data);
    } catch (error) {
    ...
    <>
      <div className={styles.background}>
        <Page>
          <br />
          <br />
          <Link href="/bebidas/form" className="btn btn-success">
            <BsPlusSquareFill /> Adicionar Bebida
          </Link>
          <br />
          <br />
          <Row md={4}>
